// ═══════════════════════════════════════════════════════════
// weatherFormatter.ts — 天氣 Embed 格式化工具
 ...
 * 
 * @param weatherList - 各縣市天氣資料陣列
 * @returns Embed 陣列（可能有多頁）
 */
export function formatWeatherOverviewEmbed(weatherList: WeatherOverviewItem[]): EmbedBuilder[] {
 ...
 * 
 * @param weatherData - 單一縣市的詳細天氣資料
 * @returns 單一 Embed
 */
export function formatWeatherDetailEmbed(weatherData: WeatherDetailItem): EmbedBuilder {
